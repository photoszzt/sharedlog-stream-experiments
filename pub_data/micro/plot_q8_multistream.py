...
def main():
    ...
    for m in metrics:
        ...
        for st in stages:
            ...
            l1, = plt.plot(ins, epoch_fa_p50, label=f'{st} epoch p50', marker=markers[0], color=colors[0])
            l2, = plt.plot(ins, epoch_fa_p99, label=f'{st} epoch p99', marker=markers[0], ls='--', color=colors[0])
            l3, = plt.plot(ins, twopc_fa_p50, label=f'{st} 2pc p50', marker=markers[1], color=colors[1])
            l4, = plt.plot(ins, twopc_fa_p99, label=f'{st} 2pc p99', marker=markers[1], ls='--', color=colors[1])
            handles = [l1, l2, l3, l4]
