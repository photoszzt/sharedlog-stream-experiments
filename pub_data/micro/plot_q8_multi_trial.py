...
def main():
    d = "./multi_instances_0extra_kvrocks_4xlarge2"
    ins=[4, 8, 16, 28, 32]
    ...
    impeller_p99 = []
    for i in ins:
        name = f"{d}/{i}ins/q8-180s-0swarm-100ms-src100ms/1/"
        rows = load(name)
        for row in rows:
            if row['del'] == "2pc":
    ...
    stat_dir="./multi_instances_0extra_kvrocks_4xlarge2/q8_180s_0swarm_100ms_src100ms_stats/0"
    groupby_cmt_p50 = []
    groupby_cmt_p99 = []
    groupby_mark_p50 = []
    groupby_mark_p99 = []
